...
bedtools intersect -wa $DHS -wb $Nanog > $outd/Nanog_intersect.bed
bedtools intersect -wa $DHS -wb $Oct4 > $outd/Oct4_intersect.bed
bedtools intersect -wa $DHS -wb $Sox2 > $outd/Sox2_intersect.bed
