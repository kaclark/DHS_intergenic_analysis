...
bedtools intersect -a $DHS -b $Nanog > $outd/Nanog_intersect.bed
bedtools intersect -a $DHS -b $Oct4 > $outd/Oct4_intersect.bed
bedtools intersect -a $DHS -b $Sox2 > $outd/Sox2_intersect.bed
