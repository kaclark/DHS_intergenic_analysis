...
with open('./data/gc.pickle', 'rb') as pickle_in:
    gc_data = pickle.load(pickle_in)
print("gc data loaded")
with open('./data/lengths.pickle', 'rb') as pickle_in:
    length_data = pickle.load(pickle_in)
print("length data loaded")
with open('./data/get_group_from_dhs.pickle', 'rb') as pickle_in:
...
for group in testing_data_group_freq.keys():
    print(group + " percentage in testing data: " + str((testing_data_group_freq[group]/500)*100))
